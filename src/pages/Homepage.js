...
const ITEMS = [
  {
    ...
    aboutEn:
      "Traditional Andhra sweet made from roasted urad dal, pure jaggery, and ghee. Rich in protein and energy.",
    aboutTe:
      "వేయించిన మినపపప్పు, శుద్ధమైన బెల్లం మరియు నెయ్యితో తయారు చేసిన సాంప్రదాయ ఆంధ్ర తీపి. ప్రోటీన్ మరియు శక్తితో నిండి ఉంటుంది.",
    benefitsEn: "High in protein, boosts energy, supports bone health.",
    benefitsTe:
      "ప్రోటీన్లు అధికంగా ఉన్నాయి, శక్తిని పెంచుతాయి, ఎముకల ఆరోగ్యానికి ఉపయోగపడతాయి.",
  ...
  },
  {
    ...
    aboutEn:
      "Gluten-free laddu made from ragi (finger millet), jaggery, and ghee. Packed with calcium and fiber.",
    aboutTe:
      "రాగితో (సామ), బెల్లం మరియు నెయ్యితో తయారు చేసిన గ్లూటెన్-రహిత లడ్డు. కాల్షియం మరియు ఫైబర్ శక్తివంతంగా ఉంటాయి.",
    benefitsEn: "Rich in calcium, aids digestion, supports weight management.",
    benefitsTe:
      "కాల్షియం అధికంగా ఉంటుంది, జీర్ణక్రియకు సహాయం చేస్తుంది, బరువు నిర్వహణకు మంచిది.",
  ...
  },
  {
    ...
    aboutEn:
      "Classic sesame-jaggery laddu loaded with healthy fats and calcium. A winter favorite.",
    aboutTe:
      "సెసేం (నువ్వు) మరియు బెల్లంతో తయారు చేసిన సంప్రదాయ లడ్డు. ఆరోగ్యకరమైన కొవ్వులు మరియు కాల్షియంతో నిండి ఉంటుంది.",
    benefitsEn: "Strengthens bones, improves skin, boosts immunity.",
    benefitsTe:
      "ఎముకలను బలపరుస్తుంది, చర్మాన్ని మెరుగుపరుస్తుంది, రోగనిరోధక శక్తిని పెంచుతుంది.",
  ...
  },
  {
    ...
    aboutEn:
      "Crunchy, protein-rich laddu made from roasted peanuts, jaggery, and ghee.",
    aboutTe:
      "వేరుశెనగలు వేయించి, బెల్లం మరియు నెయ్యితో చేసిన క్రంచీ, ప్రోటీన్-సమృద్ధి లడ్డు.",
    benefitsEn: "Boosts energy, supports muscle growth, heart-friendly.",
    benefitsTe:
      "శక్తిని పెంచుతుంది, కండరాల వృద్ధికి తోడ్పడుతుంది, హృదయానికి మంచిది.",
  ...
  },
  {
    ...
    titleTe: "రవా లడ్డు",
    aboutEn:
      "Soft, aromatic laddu made from roasted semolina, ghee, sugar, and dry fruits.",
    aboutTe:
      "వేయించిన రవా, నెయ్యి, పంచదార మరియు ఎండుచెక్కలతో తయారు చేసిన సుగంధభరితమైన లడ్డు.",
    benefitsEn: "Easy to digest, quick energy, kid-approved.",
    benefitsTe:
      "జీర్ణానికి సౌకర్యంగా, తక్షణ శక్తి అందిస్తుంది, పిల్లలకు నచ్చుతుంది.",
  ...
  // New items with Telugu fields
  {
    ...
    aboutEn:
      "Made with roasted black sesame, jaggery, and ghee — packed with iron and antioxidants.",
    aboutTe:
      "వేయించిన నల్ల నువ్వులు, బెల్లం మరియు నెయ్యితో తయారు చేయబడిన లడ్డు — ఐరన్ మరియు యాంటీఆక్సిడెంట్స్‌తో నిండి ఉంటుంది.",
    benefitsEn: "Improves blood health, strengthens hair, and boosts immunity.",
    benefitsTe:
      "రక్త ఆరోగ్యం మెరుగుపరచుతుంది, జుట్టును బలోపేతం చేస్తుంది మరియు రోగనిరోధక శక్తిని పెంచుతుంది.",
  ...
  },
  {
    ...
    titleTe: "బూందీ లడ్డు",
    aboutEn:
      "A festive favorite made with tiny gram flour pearls fried in ghee and soaked in sugar syrup.",
    aboutTe:
      "గ్రామ్ ఫ్లోర్ చిన్న రద్దీలా పొడి గుడ్డులను నెయ్యిలో వేయించి చక్కెరతో నానబెట్టిన పండుగల ప్రియమైన స్వీట్లు.",
    benefitsEn:
      "Rich in flavor, offers instant energy, and perfect for celebrations.",
    benefitsTe:
      "రుచులతో సమృద్ధిగా ఉంటుంది, తక్షణ శక్తి ఇస్తుంది మరియు పండుగలకు ఉత్కృష్టం.",
  ...
  },
  {
    ...
    aboutEn:
      "Premium laddu with almonds, cashews, dates, and figs bound in ghee.",
    aboutTe:
      "బాదము, అముండ, ఖర్జూర్, అంజిర్ వంటి డ్రై ఫ్రూట్స్‌ను నెయ్యిలో బాగా కలిపి తయారు చేసిన ప్రీమియం లడ్డు.",
    benefitsEn: "Improves stamina, boosts immunity, and heart healthy.",
    benefitsTe:
      "శక్తి పెరుగుతుంది, రోగనిరోధక శక్తి మెరుగుపడుతుంది, హృదయానికి మేలు.",
  ...
  },
  {
    ...
    aboutTe:
      "కొబ్బరి ఆధారిత మృదువైన తీపి, బెల్లం లేదా కాండెన్స్ చేసిన పాలు కలిపి తయారు చేస్తారు.",
    benefitsEn: "Good for digestion and rich in healthy fats.",
    benefitsTe:
      "జీర్ణానికి మంచిది మరియు ఆరోగ్యకరమైన కొవ్వులతో సమృద్ధిగా ఉంటుంది.",
    caloriesEn: "Approx. 115 kcal per laddu.",
    caloriesTe: "ఒక లడ్డుకు సుమారు 115 క్యాలరీలు.",
        ...
        <div className="hf-hero-inner container">
          <div className="hf-hero-left">
            <h1 className="hf-title">
              Rural Pantry — Handcrafted Laddus, Snacks & Pickles
            </h1>
            <p className="hf-sub">
              From our village kitchen to your celebrations — premium
              ingredients, artisanal small-batch sweets, and that nostalgic
              taste of home.
            </p>

            {/* Highlights as clean badges */}
            ...
            <div className="hero-card">
              <div className="hero-media">
                <img
                  ...
                  alt="Handmade sweets from Rural Pantry"
                  onError={(e) => {
              ...
              <div className="hero-note">
                ...
                <span>
                  Made in small batches. Ships same day within region.
                </span>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="alternating-content">
                ...
                <div className="telugu-block">
                  <h4>{it.titleTe}</h4>
                  <p>
                    <strong>వివరణ:</strong> {it.aboutTe}
                  </p>
                  <p>
                    <strong>ప్రయోజనాలు:</strong> {it.benefitsTe}
                  </p>
                  <p>
                    <strong>క్యాలరీలు:</strong> {it.caloriesTe}
                  </p>
                  <p>
                    <strong>అదనపు సమాచారం:</strong> {it.extraTe}
                  </p>
                </div>
              </div>
            </div>
